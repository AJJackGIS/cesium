 ...
 */
function EllipsoidElectricMaterialProperty(options) {
...
EllipsoidElectricMaterialProperty.prototype.getType = function (time) {
  return "EllipsoidElectric";
};

const timeScratch = new JulianDate();

EllipsoidElectricMaterialProperty.prototype.getValue = function (time, result) {
  if (!defined(time)) {
...
EllipsoidElectricMaterialProperty.prototype.equals = function (other) {
  return (
    this === other ||
