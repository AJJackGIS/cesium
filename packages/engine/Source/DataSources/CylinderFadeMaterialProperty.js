...
CylinderFadeMaterialProperty.prototype.getValue = function (time, result) {
  if (!defined(time)) {
...
CylinderFadeMaterialProperty.prototype.equals = function (other) {
  return (
    this === other ||
...
export default CylinderFadeMaterialProperty;
