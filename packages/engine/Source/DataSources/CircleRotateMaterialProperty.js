...
CircleRotateMaterialProperty.prototype.getType = function (time) {
  return "CircleRotate";
};

const timeScratch = new JulianDate();

CircleRotateMaterialProperty.prototype.getValue = function (time, result) {
  if (!defined(time)) {
...
CircleRotateMaterialProperty.prototype.equals = function (other) {
  return (
    this === other ||
    (other instanceof CircleRotateMaterialProperty &&
...
export default CircleRotateMaterialProperty;
