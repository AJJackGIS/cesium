 ...
 */
function WallImageTrailMaterialProperty(options) {
...
WallImageTrailMaterialProperty.prototype.getType = function (time) {
  return "WallImageTrail";
};

const timeScratch = new JulianDate();

WallImageTrailMaterialProperty.prototype.getValue = function (time, result) {
  if (!defined(time)) {
...
WallImageTrailMaterialProperty.prototype.equals = function (other) {
  return (
    this === other ||
