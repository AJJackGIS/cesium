 ...
 */
function CircleVaryMaterialProperty(options) {
...
CircleVaryMaterialProperty.prototype.getType = function (time) {
  return "CircleVary";
};

const timeScratch = new JulianDate();

CircleVaryMaterialProperty.prototype.getValue = function (time, result) {
  if (!defined(time)) {
...
CircleVaryMaterialProperty.prototype.equals = function (other) {
  return (
    this === other ||
